...
config.products_to_load_zcml = [('configure.zcml', Products.RhaptosModuleEditor),]
config.products_to_install = ['RhaptosModuleEditor']
...
def test_suite():
    ...
    suite = TestSuite()
    suite.addTest(makeSuite(TestRhaptosModuleEditor))
    return suite
