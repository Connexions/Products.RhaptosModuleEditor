...
(function() {
  ...
  define(["aloha", "jquery", "aloha/plugin", 'block/block', "block/blockmanager", 'ui/ui'], function(Aloha, jQuery, Plugin, block, BlockManager, Ui, i18n, i18nCore) {
    /*
    ...
    return Plugin.create("figure", {
      init: function() {
        ...
        initializeFigures = function($figures) {
          ...
          return imgs.on('drop', function(dropEvent) {
            var dt, img, readFile;
