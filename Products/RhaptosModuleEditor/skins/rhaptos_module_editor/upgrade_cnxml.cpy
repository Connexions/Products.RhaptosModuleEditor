...
context.getDefaultFile().upgrade(backupto=context, backupname='index.cnxml.pre-v07')
# context.logAction('upgrade')
# psm = context.translate("message_upgraded_07", domain="rhaptos", default="Upgraded to CNXML version 0.7.")
